            ...
            <div class="navbar navbar-inverse">
                <div class="navbar-inner">
                    <ul class="nav pull-left">
                        ...
                        <li class="divider-vertical"></li>
                        <li><a class="fontello-icon-home-3" href="index.php"></a></li>
                        <li class="divider-vertical"></li>
                    </ul>
...
<?php
 if ($page=='crearResultado') {
     echo ' <script src="assets/js/jsPDF/jspdf.js"></script>
            <script  src="assets/js/jsPDF/jspdf.plugin.standard_fonts_metrics.js"></script> 
            <script  src="assets/js/jsPDF/jspdf.plugin.split_text_to_size.js"></script>               
            <script  src="assets/js/jsPDF/jspdf.plugin.from_html.js"></script>
            <script  src="assets/js/jsPDF/jspdf.plugin.cell.js"></script>
...
$(function() {
   ...
   $('.open-suprim').click(function(e){
               ...
               var SHOW = "EVENTO: " + $(this).data('titulo');
   ...
   $('.open-suprim-paciente').click(function(e){
    ...
    $('.open-suprim-prueba').click(function(e){
               ...
               var Prueba = "PRUEBA : " + $(this).data('titulo');
               $("#titulo-borrado").text(Prueba);
               $(".modal-footer #pruebaid").val( Pru);
          });
    $('.open-suprim-consulta').click(function(e){
               var Cons = $(this).data('id');
               var Consulta = "CONSULTA DE : " + $(this).data('titulo');
               var Paciente = "REGISTRADA PARA: "+$(this).data('paciente');
               $("#titulo-borrado").text(Consulta);
               $("#paciente-actual").text(Paciente);
               $(".modal-footer #consultaid").val( Cons);
          });
